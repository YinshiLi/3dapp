...
$(document).ready(function () {
    ...
    $.getJSON('../application/model/data.json', function (jsonObj) {
        ...
        $('#x3dModelTitle_coke').html('<p>' + jsonObj.pageTextData[4].x3dModelTitle + '</p>');
        ...
        $('#x3dModelTitle_sprite').html('<p>' + jsonObj.pageTextData[5].x3dModelTitle + '</p>');
        ...
        $('#x3dModelTitle_pepper').html('<p>' + jsonObj.pageTextData[6].x3dModelTitle + '</p>');
